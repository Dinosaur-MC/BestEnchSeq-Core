...
public:
    ...
    EnchantmentRegistry(const EnchantmentRegistry&) = delete;
    EnchantmentRegistry(EnchantmentRegistry&&) = default;  // create_subset() returns by value
    EnchantmentRegistry& operator=(const EnchantmentRegistry&) = delete;
    EnchantmentRegistry& operator=(EnchantmentRegistry&&) = delete;  // no reassignment after init
