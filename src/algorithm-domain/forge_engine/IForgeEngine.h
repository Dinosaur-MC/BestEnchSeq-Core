...
public:
    ...
    virtual std::pair<Item, int32_t> forge(const Item& target,
    ...
    virtual void pure_forge_into(Item& target, const Item& sacrifice,
    ...
    virtual int32_t estimate_forge_cost(const Item& target,
                                         const Item& sacrifice,
