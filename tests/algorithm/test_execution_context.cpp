...
struct MockObserver : AlgorithmObserver {
    ...
    void on_solution_found(size_t task_id, const std::vector<compact::EnchStep>&) override {
...
void test_observer_progress() {
    ...
    ExecutionContext ctx(42, "test_obs");
    ctx.report_progress(50, ProgressStatus::Exploring);
    drain_events();
...
void test_observer_solution() {
    ...
    ExecutionContext ctx(7, "test_sol");
    compact::EnchStep dummy{};
    std::vector<compact::EnchStep> steps;
...
void test_observer_solution_rvalue() {
    ...
    ExecutionContext ctx(8, "test_sol_rv");
    std::vector<compact::EnchStep> steps;
    steps.push_back({{}, {}, 3});
    steps.push_back({{}, {}, 7});
...
void test_observer_exit() {
    ...
    ExecutionContext ctx(33, "test_exit");
