...
void test_json_basic() {
    ...
    expect(eqs[0].category == "sword", "json: sword category");
    ...
    expect(eqs[1].category == "pickaxe", "json: pickaxe category");
...
void test_csv_basic() {
    ...
    expect(eqs[0].category == "sword", "csv: first category");
...
void test_custom_category() {
    ...
    expect(eqs[0].category == "custom_weapon", "custom cat: category preserved as string");
...
void test_missing_fields_skipped() {
    ...
    for (const auto &eq : eqs) {
        if (eq.name_id == "valid") {
            ...
            expect(eq.category == "sword", "missing fields: valid category");
        ...
        if (eq.name_id == "no_name") {
            ...
            expect(eq.category == "pickaxe", "missing fields: pickaxe category");
...
void test_json_mixed_with_enchantments() {
    ...
    expect(eqs[0].category == "sword", "mixed json: category");
...
void test_to_json_round_trip() {
    ...
    if (parsed.size() >= 1) {
        ...
        expect(parsed[0].category == "sword", "eq JSON round-trip: category");
