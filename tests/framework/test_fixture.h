...
inline void TestFixture::init_sword_set() {
    ...
    enchants = EnchantmentRegistry({
        EnchInfo{NSID("sharpness"), "Sharpness", MCE::All, 5, 5, 1, false, std::unordered_set<NSID>{},
                 std::unordered_set<NSID>{EquipmentTag::sword()}},
        EnchInfo{NSID("knockback"), "Knockback", MCE::All, 2, 2, 2, false, std::unordered_set<NSID>{},
                 std::unordered_set<NSID>{EquipmentTag::sword()}},
        EnchInfo{NSID("bane_of_arthropods"), "Bane of Arthropods", MCE::All, 5, 5, 1, false,
                 std::unordered_set<NSID>{NSID("sharpness")}, std::unordered_set<NSID>{EquipmentTag::sword()}},
        EnchInfo{NSID("protection"), "Protection", MCE::All, 4, 4, 1, false, std::unordered_set<NSID>{},
                 std::unordered_set<NSID>{EquipmentTag::chestplate()}},
    });
    equipment = EquipmentRegistry({
        {NSID("minecraft:diamond_sword"), "Diamond Sword", EquipmentTag::sword(), 1561},
        {NSID("minecraft:diamond_chestplate"), "Diamond Chestplate", EquipmentTag::chestplate(), 528},
    });
}
...
inline void TestFixture::init_chestplate_set() {
    ...
    enchants = EnchantmentRegistry({
        EnchInfo{NSID("protection"), "Protection", MCE::All, 4, 4, 1, false, std::unordered_set<NSID>{},
                 std::unordered_set<NSID>{EquipmentTag::chestplate()}},
        EnchInfo{NSID("unbreaking"), "Unbreaking", MCE::All, 3, 3, 1, false, std::unordered_set<NSID>{},
                 std::unordered_set<NSID>{EquipmentTag::chestplate()}},
        EnchInfo{NSID("thorns"), "Thorns", MCE::All, 3, 3, 1, false, std::unordered_set<NSID>{},
                 std::unordered_set<NSID>{EquipmentTag::chestplate()}},
    });
    equipment = EquipmentRegistry({
        {NSID("minecraft:diamond_chestplate"), "Diamond Chestplate", EquipmentTag::chestplate(), 528},
